...
<body>
<h3>添加商品</h3>
<form action="doAdminAction.php?act=addProIn" method="post" enctype="multipart/form-data">
<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	...
	<tr>
		...
		<td><input type="text" name="firm"  placeholder="请输入商品厂家"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="iPrice"  placeholder="请输入商品单价"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="operator"  placeholder="请输入操作人员姓名"/></td>
	</tr>
<!-- 	<tr>
