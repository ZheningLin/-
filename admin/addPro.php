...
<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	...
	<tr>
		...
		<td><input type="text" name="size"  placeholder="请输入商品规格"/></td>
	</tr>
	<tr>
		<td align="right">最低库存</td>
		<td><input type="text" name="lowhold"  placeholder="请输入商品最低库存"/></td>
	</tr>
	<tr>
		<td align="right">出库价</td>
		<td><input type="text" name="oPrice"  placeholder="请输入商品出库价"/></td>
	</tr>
	<tr>
		<td align="right">入库价</td>
		<td><input type="text" name="iPrice"  placeholder="请输入商品入库价"/></td>
	</tr>
		<tr>
		<td align="right">厂商</td>
		<td><input type="text" name="firm"  placeholder="请输入商品入库价"/></td>
	</tr>
<!-- 	<tr>
