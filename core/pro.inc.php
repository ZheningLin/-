...
function getProById($id){
	    ...
	    $sql="select p.id,p.pName,p.pSn,p.pNum,p.oPrice,p.iPrice,p.pDesc,p.lowhold,p.size,p.firm,c.cName from imooc_pro as p join imooc_cate c on p.cId=c.id where p.id={$id}";
		$row=fetchOne($sql);
		return $row;
}
/**
